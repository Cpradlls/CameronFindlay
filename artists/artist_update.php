...
<body>
    ...
    <main class="upDe">
        ...
        $artistId = $_POST['artist_id_Up'] ?? false; // On récupère l'id du genre que l'on veut supprimer
        $artistName = $_POST['artist_name_Up'] ?? false;

        $requete = "UPDATE `artistsCP` SET `artist_name` = :artist_name WHERE `artist_id` = :artist_id";
        ...
        if (isset($resultat)) {
            echo "<div class='resultat'>";
                echo "<p>L'artist " . htmlentities($artistName, ENT_QUOTES) . " a bien été modifié !</p>";
