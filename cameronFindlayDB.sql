...
--
-- Host: localhost:8889
-- Generation Time: Apr 05, 2021 at 08:40 AM
...
--
-- Database: `CameronFindlay`
--

-- --------------------------------------------------------

--
-- Table structure for table `artistsCP`
--

CREATE TABLE `artistsCP` (
  `artist_id` int(11) NOT NULL,
  `artist_name` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `artistsCP`
--

INSERT INTO `artistsCP` (`artist_id`, `artist_name`) VALUES
(1, 'Julien Doré'),
(2, 'Amel Bent'),
(3, 'Angele'),
(4, 'Garou'),
...
--
-- Table structure for table `assoc_artists_stylesCP`
--

CREATE TABLE `assoc_artists_stylesCP` (
  `assoc_ar_sty_id` int(11) NOT NULL,
  `assoc_artist_id` int(11) NOT NULL,
  `assoc_style_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `assoc_artists_stylesCP`
--

INSERT INTO `assoc_artists_stylesCP` (`assoc_ar_sty_id`, `assoc_artist_id`, `assoc_style_id`) VALUES
(1, 1, 348),
(3, 2, 45),
(4, 3, 168),
(5, 4, 346),
...
--
-- Table structure for table `genresCP`
--

CREATE TABLE `genresCP` (
  `genre_id` int(11) NOT NULL,
  `genre_name` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

--
-- Dumping data for table `genresCP`
--

INSERT INTO `genresCP` (`genre_id`, `genre_name`) VALUES
(1, 'BluesS'),
(3, 'Children’s'),
(4, 'Classical'),
(5, 'Electronic'),
...
--
-- Table structure for table `stylesCP`
--

CREATE TABLE `stylesCP` (
...
--
-- Dumping data for table `stylesCP`
--

INSERT INTO `stylesCP` (`style_id`, `style_name`, `style_genre_id`) VALUES
(1, 'Boogie Woogie', 1),
(2, 'Chicago Blues', 1),
(3, 'Country Blues', 1),
(4, 'Delta Blues', 1),
...
--
-- Indexes for table `artistsCP`
--
ALTER TABLE `artistsCP`
  ADD PRIMARY KEY (`artist_id`);

--
-- Indexes for table `assoc_artists_stylesCP`
--
ALTER TABLE `assoc_artists_stylesCP`
  ADD PRIMARY KEY (`assoc_ar_sty_id`),
  ADD KEY `assoc_artist_id` (`assoc_artist_id`),
  ADD KEY `assoc_style_id` (`assoc_style_id`);

--
-- Indexes for table `genresCP`
--
ALTER TABLE `genresCP`
  ADD PRIMARY KEY (`genre_id`);

--
-- Indexes for table `stylesCP`
--
ALTER TABLE `stylesCP`
...
--
-- AUTO_INCREMENT for table `artistsCP`
--
ALTER TABLE `artistsCP`
  MODIFY `artist_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `assoc_artists_stylesCP`
--
ALTER TABLE `assoc_artists_stylesCP`
  MODIFY `assoc_ar_sty_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `genresCP`
--
ALTER TABLE `genresCP`
  MODIFY `genre_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `stylesCP`
--
ALTER TABLE `stylesCP`
  MODIFY `style_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=593;
...
--
-- Constraints for table `assoc_artists_stylesCP`
--
ALTER TABLE `assoc_artists_stylesCP`
  ADD CONSTRAINT `assoc_artists_stylescp_ibfk_1` FOREIGN KEY (`assoc_artist_id`) REFERENCES `artistscp` (`artist_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `assoc_artists_stylescp_ibfk_2` FOREIGN KEY (`assoc_style_id`) REFERENCES `stylescp` (`style_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `stylesCP`
--
ALTER TABLE `stylesCP`
  ADD CONSTRAINT `stylescp_ibfk_1` FOREIGN KEY (`style_genre_id`) REFERENCES `genrescp` (`genre_id`) ON DELETE SET NULL ON UPDATE CASCADE;
