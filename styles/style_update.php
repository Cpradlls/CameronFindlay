...
<body>
    ...
    <main class="upDe">
        ...
        $styleId = $_POST['style_id_Up'] ?? false; // On récupère l'id du genre que l'on veut supprimer
        $styleName = $_POST['style_name_Up'] ?? false;
        $styleGenreId = $_POST['style_genre_id'] ?? false;

        //////////////////Préparation de la requete modifier //////////
        $requete = "UPDATE `stylesCP` SET `style_name` = :style_name, `style_genre_id` = :style_genre_id WHERE `style_id` = :style_id";
